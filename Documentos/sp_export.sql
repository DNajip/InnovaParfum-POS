...
BEGIN
    ...
    -- 4. Insertar Venta
    INSERT INTO VEN.VENTAS (ID_TURNO, ID_USUARIO, ID_PERSONA, FECHA_VENTA, TASA_CAMBIO_USD, SUBTOTAL_NIO, DESCUENTO_NIO, TOTAL_NIO, ANULADA, ID_TIPO_VENTA, ID_CONDICION_PAGO, SALDO_PENDIENTE)
    VALUES (@IdTurno, @IdUsuario, @IdPersona, @FechaActual, @TasaCambioUsd, @SubtotalNio, @DescuentoNio, @TotalVentaNio, 0, @IdTipoVenta, @IdCondicionPago, @SaldoPendiente);
    ...
    UPDATE T SET 
        ...
        T.TOTAL_VENTAS_NIO += @TotalPagadoNio, -- En POS solo sumamos lo realmente cobrado para cuadre
